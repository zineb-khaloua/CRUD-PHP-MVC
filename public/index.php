...
// Composer autoload to load classes
require __DIR__ . '/../vendor/autoload.php';

// Loading configuration files and helpers
require_once __DIR__ . '/../src/Helpers/header.php';
...
$router->setBasePath('/stagiaire-testing/public');
